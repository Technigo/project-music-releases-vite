...
// This component takes a prop named 'artistsArray' and destructures it from the props object, and render a <div> element with the class "artist-name-link" to contain the artist names. Use the .map() method to iterate over the 'artistsArray' and render artist names. The 'key' prop is set to 'mappedOutArtist.id' to identify each artist uniquely. Inside the <h3>, render an <a> link with the artist's name and Spotify link. Include the "ArtistSeparate" component, passing 'index' and 'length' as props.
